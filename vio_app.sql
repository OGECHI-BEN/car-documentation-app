...
--
-- Host: 127.0.0.1
-- Generation Time: May 14, 2024 at 11:38 AM
...
CREATE TABLE `vehiclemake` (
  `vehicleMake_id` int(11) NOT NULL,
...
ALTER TABLE `vehiclemake`
  ADD PRIMARY KEY (`vehicleMake_id`);

--
-- Indexes for table `vehicletype`
--
ALTER TABLE `vehicletype`
  ADD PRIMARY KEY (`vehicleTyp_id`);
...
--
ALTER TABLE `vehiclemake`
  MODIFY `vehicleMake_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `vehicletype`
--
ALTER TABLE `vehicletype`
  MODIFY `vehicleTyp_id` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
